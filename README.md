...
The long-term goal is to provide a persistent RFID/NFC virtual keyboard service that can start automatically with the system, especially through a `systemd` service on Linux.
